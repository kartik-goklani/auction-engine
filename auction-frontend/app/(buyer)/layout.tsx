        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2.5 pl-2.5 ml-0.5 border-l border-border-subtle">
            ...
            <div className="hidden sm:block">
              <p className="text-[12px] font-semibold text-text-primary leading-tight max-w-[120px] truncate">{displayName || 'Buyer'}</p>
              <p className="text-[10px] text-text-muted leading-tight">Buyer</p>
            </div>
            <button
              type="button"
